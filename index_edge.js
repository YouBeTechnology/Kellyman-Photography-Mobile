...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['49px', '143px','422px','617px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'image',
                rect: ['11px', '25px','480px','800px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['0px', '705px','485px','171px','auto', 'auto'],
                opacity: 0.79545453190804,
                fill: ["rgba(0,0,0,1.00)",[270,[['rgba(85,85,85,1.00)',0],['rgba(0,0,0,1.00)',55]]]],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['45px', '761px','415px','33px','auto', 'auto'],
                opacity: 0.61931818181818,
                text: "Quality, Professionalism, Picture Perfect",
                align: "center",
                font: ['Palatino Linotype, Book Antigua, Palatino, serif', 21, "rgba(255,255,255,1.00)", "400", "none", "italic"]
            },
            {
                id: 'Buttons_Movie',
                display: 'block',
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['41px', '787px','451px','66px','auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid933", tween: [ "style", "${_contact}", "left", '34px', { fromValue: '29px'}], position: 4354, duration: 275, easing: "easeInBack" },
                { id: "eid1104", tween: [ "style", "${_contact}", "left", '31px', { fromValue: '34px'}], position: 4629, duration: 295, easing: "easeOutBack" },
                ...
                { id: "eid153", tween: [ "style", "${_Home_Footer_Text}", "top", '800px', { fromValue: '801px'}], position: 1549, duration: 214, easing: "easeInOutBack" },
                ...
                { id: "eid1074", tween: [ "style", "${_testkellyman}", "opacity", '0.16239295594203', { fromValue: '0'}], position: 9500, duration: 196, easing: "easeInOutBack" },
                ...
                { id: "eid468", tween: [ "style", "${_Services_Child_Picture}", "opacity", '0.19066194884288', { fromValue: '0.37606820196677'}], position: 7450, duration: 219, easing: "easeInOutBack" },
