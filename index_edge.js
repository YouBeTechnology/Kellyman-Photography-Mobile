...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['0px', '0px','503px','860px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['0px', '69px','480px','123px','auto', 'auto'],
                fill: ["rgba(0,0,0,1)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['67px', '96px','356px','44px','auto', 'auto'],
                text: "Testimonies",
                align: "center",
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['49px', '187px','460px','469px','auto', 'auto'],
            ...
            },
            {
                ...
                align: "center",
                font: ['Palatino Linotype, Book Antigua, Palatino, serif', 22, "rgba(255,255,255,1.00)", "500", "none", "italic"]
            },
            {
                id: 'updateholder',
                display: 'none',
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['81px', '716px','356px','44px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['37px', '454px','171px','86px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['278px', '454px','171px','86px','auto', 'auto'],
                fill: ["rgba(255,255,255,1)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['37px', '554px','171px','86px','auto', 'auto'],
                fill: ["rgba(255,255,255,1)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['278px', '554px','171px','86px','auto', 'auto'],
                fill: ["rgba(255,255,255,1)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['37px', '657px','171px','86px','auto', 'auto'],
                fill: ["rgba(255,255,255,1)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['281px', '657px','171px','86px','auto', 'auto'],
                fill: ["rgba(255,255,255,1)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            }],
            symbolInstances: [
    ...
    states: {
        "Base State": {
            ...
            "${_Buttons_Movie}": [
                ["style", "top", '193px'],
                ["transform", "scaleY", '0.07633'],
                ["style", "display", 'block'],
                ["transform", "scaleX", '0.03505'],
                ["style", "opacity", '0'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid144", tween: [ "style", "${_Buttons_Movie}", "left", '9px', { fromValue: '3px'}], position: 1250, duration: 370, easing: "easeInOutBack" },
                { id: "eid140", tween: [ "transform", "${_Buttons_Movie}", "scaleX", '1.06186', { fromValue: '0.03505'}], position: 1250, duration: 370, easing: "easeInOutBack" },
                ...
                { id: "eid500", tween: [ "style", "${_Mobile_Home_Mid_HolderCopy}", "display", 'block', { fromValue: 'none'}], position: 1575, duration: 0, easing: "easeInOutBack" },
                ...
                { id: "eid468", tween: [ "style", "${_Services_Child_Picture}", "opacity", '0.28478991835057', { fromValue: '0.37606820196677'}], position: 7450, duration: 219, easing: "easeInOutBack" },
                ...
                { id: "eid577", tween: [ "style", "${_Testmonies_Banner}", "display", 'block', { fromValue: 'block'}], position: 9255, duration: 0, easing: "easeInOutBack" },
                { id: "eid579", tween: [ "style", "${_Testmonies_Banner}", "display", 'block', { fromValue: 'none'}], position: 9338, duration: 0, easing: "easeInOutBack" },
                ...
                { id: "eid586", tween: [ "style", "${_Testmonies_Text}", "opacity", '1', { fromValue: '0'}], position: 9500, duration: 246, easing: "easeInOutBack" },
                ...
                { id: "eid697", tween: [ "style", "${_Flash_Movie}", "top", '-179px', { fromValue: '-179px'}], position: 1526, duration: 0, easing: "easeInOutBack" },
                ...
                { id: "eid193", tween: [ "style", "${_Kellyman_About_Trans_Photo}", "opacity", '0.56302521008403', { fromValue: '0'}], position: 2943, duration: 307, easing: "easeInOutBack" },
                { id: "eid944", tween: [ "style", "${_RoundRect2}", "display", 'none', { fromValue: 'block'}], position: 5000, duration: 0, easing: "easeInOutBack" },
                { id: "eid581", tween: [ "style", "${_Testmonies_Banner}", "opacity", '1', { fromValue: '0'}], position: 9255, duration: 250, easing: "easeInOutBack" },
                ...
                { id: "eid941", tween: [ "style", "${_RoundRect2}", "opacity", '0.21008403599262238', { fromValue: '0'}], position: 4864, duration: 60, easing: "easeInOutBack" },
                { id: "eid939", tween: [ "style", "${_RoundRect2Copy}", "opacity", '0.15126051008701324', { fromValue: '0'}], position: 4864, duration: 60, easing: "easeInOutBack" },
                ...
                { id: "eid153", tween: [ "style", "${_Home_Footer_Text}", "top", '799px', { fromValue: '801px'}], position: 1575, duration: 290, easing: "easeInOutBack" },
                { id: "eid148", tween: [ "style", "${_Buttons_Movie}", "opacity", '0.88000001907349', { fromValue: '0'}], position: 1250, duration: 370, easing: "easeInOutBack" },
                ...
                { id: "eid151", tween: [ "style", "${_Buttons_Movie}", "clip", [464.000244140625,485,754.666748046875,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [464.000244140625,485,804,0]}], position: 1355, duration: 265, easing: "easeInOutBack" },
                ...
                { id: "eid585", tween: [ "style", "${_Testmonies_Text}", "display", 'none', { fromValue: 'none'}], position: 9500, duration: 0, easing: "easeInOutBack" },
                { id: "eid589", tween: [ "style", "${_Testmonies_Text}", "display", 'block', { fromValue: 'none'}], position: 9592, duration: 0, easing: "easeInOutBack" },
                ...
                { id: "eid582", tween: [ "style", "${_Testmonies_Banner}", "top", '19px', { fromValue: '-1px'}], position: 9255, duration: 250, easing: "easeInOutBack" },
                ...
                { id: "eid142", tween: [ "transform", "${_Buttons_Movie}", "scaleY", '1.06965', { fromValue: '0.07633'}], position: 1250, duration: 370, easing: "easeInOutBack" },
                ...
                { id: "eid155", tween: [ "style", "${_Home_Footer_Text}", "opacity", '0.6193181872367859', { fromValue: '0'}], position: 1575, duration: 290, easing: "easeInOutBack" },
                ...
                { id: "eid937", tween: [ "style", "${_RoundRect2Copy2}", "opacity", '0.15126051008701324', { fromValue: '0'}], position: 4864, duration: 60, easing: "easeInOutBack" },
                { id: "eid146", tween: [ "style", "${_Buttons_Movie}", "top", '5px', { fromValue: '193px'}], position: 1250, duration: 370, easing: "easeInOutBack" },
                ...
                { id: "eid235", tween: [ "style", "${_Mobile_Home_Mid_Holder}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0, easing: "easeInOutBack" },
                { id: "eid238", tween: [ "style", "${_Mobile_Home_Mid_Holder}", "display", 'block', { fromValue: 'none'}], position: 1575, duration: 0, easing: "easeInOutBack" },
                { id: "eid169", tween: [ "style", "${_Mobile_Home_Mid_Holder}", "display", 'none', { fromValue: 'block'}], position: 2070, duration: 0, easing: "easeInOutBack" },
...
"content": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid886", tween: [ "color", "${_photoholder}", "background-color", 'rgba(25,2,2,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(25,2,2,1.00)'}], position: 1926, duration: 0, easing: "easeInOutBack" },
                { id: "eid885", tween: [ "style", "${_photoholder}", "opacity", '1', { fromValue: '0'}], position: 1374, duration: 552, easing: "easeInOutBack" },
                { id: "eid889", tween: [ "style", "${_photoholder}", "display", 'block', { fromValue: 'none'}], position: 1374, duration: 0, easing: "easeInOutBack" },
...
"callus": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['138px', '675px', '216px', '26px', 'auto', 'auto'],
                    borderRadius: ['10px', '10px', '10px', '10px'],
                    id: 'RoundRect',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    type: 'rect',
                ...
                {
                    rect: ['182px', '677px', 'auto', 'auto', 'auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid911", tween: [ "style", "${_RoundRect}", "top", '675px', { fromValue: '745px'}], position: 0, duration: 0, easing: "easeInOutBack" },
                ...
                { id: "eid912", tween: [ "style", "${_Text}", "top", '677px', { fromValue: '747px'}], position: 0, duration: 0, easing: "easeInOutBack" }            ]
        }
    }
},
"viiewgal": {
